...
var url=process.env.DATABASEURL || "mongodb://localhost:27017/playground_app";
// mongoose.connect('mongodb://localhost:27017/playground_app', { useNewUrlParser: true, useCreateIndex: true });
// mongoose.connect('mongodb+srv://dbUser:slr94AK@cluster0-bfcz2.mongodb.net/test?retryWrites=true', { useNewUrlParser: true, useCreateIndex: true });
